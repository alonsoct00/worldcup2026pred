...
// Single source of truth — update this file daily or via sync button

export const LAST_UPDATED = "2026-06-16T18:00:00Z"
...
export const groups: Group[] = [
  ...
  },
  {
    ...
    teams: [
      ...
      { name: "Austria",   flag: "🇦🇹", played: 1, w: 1, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { name: "Argelia",   flag: "🇩🇿", played: 1, w: 0, d: 0, l: 1, gf: 0, ga: 2, pts: 0 },
      { name: "Jordania",  flag: "🇯🇴", played: 1, w: 0, d: 0, l: 1, gf: 0, ga: 0, pts: 0 },
    ],
    projected: ["🇦🇷 Argentina (1°)", "🇦🇹 Austria (2°)"],
    matches: [
      { id:"J1", home:"Argentina", away:"Argelia", homeFlag:"🇦🇷", awayFlag:"🇩🇿", homeScore:2, awayScore:0, homePrediction:2, awayPrediction:0, date:"16 jun", venue:"Arrowhead, Kansas City", status:"played", result:"home", notes:"Messi (17') + Álvarez. Gol inicial de Messi anulado por offside. Casi 80% del estadio con camiseta albiceleste." },
      { id:"J2", home:"Austria", away:"Jordania", homeFlag:"🇦🇹", awayFlag:"🇯🇴", homeScore:null, awayScore:null, homePrediction:2, awayPrediction:0, date:"16 jun", venue:"Levi's Stadium, San Francisco", status:"upcoming", result:null },
