...
export const knockoutMatches: KnockoutMatch[] = [
  ...
  { id:"sf-2", round:"sf", home:"Inglaterra", away:"Argentina", homeFlag:"🏴󠁧󠁢󠁥󠁮󠁧󠁿", awayFlag:"🇦🇷", homeScore:null, awayScore:null, homePrediction:1, awayPrediction:2, winner:"Argentina", winnerFlag:"🇦🇷", status:"upcoming", extra:"AET", date:"15 jul", notes:"ACTUALIZADO: el cruce real no es Francia vs Argentina (Francia ya quedó eliminado en la sf-1 ante España) — es Bellingham vs Messi. Argentina, campeón defensor, es favorito pero Inglaterra ha sido letal en la fase KO." },
  { id:"third", round:"third", home:"Francia", away:"Inglaterra", homeFlag:"🇫🇷", awayFlag:"🏴󠁧󠁢󠁥󠁮󠁧󠁿", homeScore:null, awayScore:null, homePrediction:2, awayPrediction:1, winner:"Francia", winnerFlag:"🇫🇷", status:"upcoming", date:"18 jul", notes:"ACTUALIZADO: el tercer lugar depende de quién pierda la sf-2. Predicción: Francia (eliminada por España en semis) vs el perdedor de Inglaterra-Argentina. Mbappé se despide con el bronce." },
